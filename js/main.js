    ...
    xmlhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            if (xmlhttp.response == 0) {
                document.getElementById("atl_btn").hidden = true;
                document.getElementById("bttn").hidden = true;
                // location.assign("checkifinlist.php");
            }else{
                document.getElementById("atl_btn").hidden = false;
...
function bookthisticket () {
    ...
    // var currentSes = document.getElementById("sessionbtntext").textContent;
